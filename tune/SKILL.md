---
name: tune
description: Design dial adjustments for a single dimension. Use when the user wants to change the intensity, mood, or quality of a specific aspect of the design — amplify, quiet, colorize, strip, animate, delight, clarify typography, or push past limits.
version: 1.0.0
user-invocable: true
